...
{query}"""
    ...
    async def _retrieve(
        ...
        from open_webui.retrieval.utils import get_last_embedding_usage, query_collection
        ...
        async def observed_embedding(values: Any, prefix: Any = None, user: Any = None) -> Any:
            ...
            # "not reported" status for every other engine, or if Gemini
            # didn't report usage for this specific call.
